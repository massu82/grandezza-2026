<x-layout-admin title="Candidatos">
    <div class="flex items-center justify-between mb-4">
        <h1 class="text-2xl font-semibold text-primary" style="font-family: 'Playfair Display', serif;">Candidatos</h1>
                ...
                @forelse($candidates as $candidate)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-sm text-right space-x-2">
                            <a href="{{ url('/admin/candidates/'.$candidate->id) }}" class="text-primary hover:underline">Ver</a>
                        </td>
                    </tr>
                @empty
                    <tr>
