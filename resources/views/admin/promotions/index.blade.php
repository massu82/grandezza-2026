<x-layout-admin title="Promociones">
    <div class="flex items-center justify-between mb-4">
        <h1 class="text-2xl font-semibold text-rose-950" style="font-family: 'Playfair Display', serif;">Promociones</h1>
        <a href="{{ url('/admin/promotions/create') }}" class="inline-flex items-center px-4 py-2 rounded-lg bg-rose-900 text-white text-sm font-semibold hover:bg-rose-800">Nueva promoción</a>
    </div>
